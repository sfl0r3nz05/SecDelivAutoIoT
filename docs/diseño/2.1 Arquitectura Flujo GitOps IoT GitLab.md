...
7. GitLab CI/CD del repositorio de configuración se conecta mediante SSH a la Máquina Virtual y despliega la imagen almacenada en Docker Hub en el cluster Kubernetes de las Raspberry Pis.
