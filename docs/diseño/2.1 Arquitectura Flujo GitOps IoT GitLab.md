...
4. Si las pruebas de seguridad son exitosas, GitLab CI/CD construirá la imagen de la aplicación y la almacenará en Docker Hub.
5. Después de almacenar la imagen en Docker Hub, se analaiza la seguridad de la imagen con Trivy.
